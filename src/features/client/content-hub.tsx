...
import { ClientContents, type ContentFilter } from "@/features/client/contents";
 ...
 */
export async function ClientContentHub({
  defaultTab = "content",
  contentFilter,
}: {
  defaultTab?: ContentHubTab;
  ...
  return (
    <ClientDetailTabs
      ...
      tabs={[
        { id: "content", label: dict.nav.content, content: <ClientContents filter={contentFilter} /> },
